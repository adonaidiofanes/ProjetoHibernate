	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if ((request.getParameter("Controle") != null)
			...
			if( resultadoProc.equals("sucesso") ){
				...
				resultadoProc = "<div class='alert alert-danger'>N�o foi poss�vel cadastrar o agendamento!</div>";
			} else {
				resultadoProc = "";
			}
		...
		if ((request.getParameter("Controle") != null)
			...
			if( resultadoProc.equals("sucesso") ){
				if( resultadoProc.equals("sucesso") ){
					...
					resultadoProc = "<div class='alert alert-danger'>N�o foi poss�vel cancelar o atendimento!</div>";
				} else {
					resultadoProc = "";
				}
			} else {
		...
		if ((request.getParameter("Controle") != null)
			...
			if( retornoStatusR.equals("sucesso") ){
				if( resultadoProcIns.equals("sucesso") ){
					...
					resultadoProcIns = "<div class='alert alert-danger'>N�o foi poss�vel efetuar o agendamento!</div>";
				} else {
					resultadoProcIns = "";
				}
			} else {
		...
		if ((request.getParameter("Controle") != null)
			...
			// Recebe todo conte�do para transformar em JSON
