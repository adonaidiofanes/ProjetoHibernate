...
%>
	...
	<div class="container">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Cancelar Atendimento</li>
		</ol>
		...
		<div class="row-fluid">
			<div class="panel panel-primary">
				...
				<div class="panel-heading">
					<h3 class="panel-title">Cancelar Atendimento</h3>
				</div>

				<div class="panel-body">

					<form id="formCancelarAtendimento" action="/ProjetoHibernate/AtendimentoServlet.do" class="form-horizontal" role="form" form method="post">
						...
						<div class="form-group">
							...
							<div class="text-right">
								<button type="submit" class="btn btn-danger" id="Buscar"><span class="glyphicon glyphicon glyphicon-remove"></span> Cancelar Atendimento </button>
							</div>
							
							<input type="hidden" id="Controle" name="Controle" value="CancelarAtendimento" />
							...
							<input type="hidden" id="idcliente" name="idcliente" value="<%= os.getIdCliente() %>">
