...
<title>Solicitar Fechamento OS #<%= IdOs %></title>
...
<body>
	...
	<div class="container">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Solicitar Fechamento da OS #<%= IdOs %></li>
		</ol>

		<div class="row-fluid">
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h3 class="panel-title">Solicitar Fechamento de OS</h3>
				</div>
				...
				<div class="panel-body">
					...
					<form class="form-horizontal" role="form" form method="post"
						...
						<input type="hidden" value="SolicitarFechamento" name="Controle" id="SolicitarFechamento" />
						<input type="hidden" value="<%= IdOs %>" name="IdOs" id="IdOs" />
						
						<div class="row text-right col-sm-12">
							<button type="submit" class="btn btn-warning"><span class="glyphicon glyphicon-eye-close"></span> Solicitar Fechamento</button>
						</div>
