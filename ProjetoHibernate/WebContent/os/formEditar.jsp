...
<body>
	...
	<div class="container">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Editando OS #<%= IdOs %></li>
		</ol>

		<div class="row-fluid">
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h3 class="panel-title">Editar OS</h3>
				</div>
				...
				<div class="panel-body">
					...
					<form class="form-horizontal" role="form" form method="post"
						...
						<div class="col-md-6">
							...
							<!-- div class="form-group">
								<label for="slcStatus" class="col-sm-4 control-label">
								Status</label>
								<div class="col-sm-8">
									<%= slcStatus %>
								</div>
						...
						<input type="hidden" value="Atualizar" name="Controle" id="Atualizar" />
						<input type="hidden" value="<%= IdOs %>" name="IdOs" id="IdOs" />
						
						<div class="row text-right col-sm-12">
							<button type="submit" class="btn btn-success"><span class="glyphicon glyphicon-floppy-saved"></span> Salvar</button>
						</div>
